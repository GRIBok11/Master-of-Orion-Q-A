...
#vectorstore = Chroma.from_documents(documents=split_docs, embedding=embedding_function,persist_directory="vectre")
"""
...
retriever = ParentDocumentRetriever(vectorstore.as_retriever(search_type="similarity", search_kwargs={"k": 5}))
"""
"""
loader = TextLoader("moo2.md", encoding="utf-8")
